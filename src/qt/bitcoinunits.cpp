...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SAC");
    case mBTC: return QString("mSAC");
    case uBTC: return QString::fromUtf8("μSAC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("SACoins"));
    case mBTC: return QString(QObject::tr("Milli-SACoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-SACoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
